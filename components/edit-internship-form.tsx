  ...
  return (
    ...
    >
      <div className="border-b border-slate-200 pb-4">
        <h2 className="text-xl font-semibold tracking-[-0.02em] text-slate-900">Edit internship</h2>
        <p className="mt-1 text-sm text-slate-600">Update listing details and requirements.</p>
      </div>
      ...
      <div className="mt-6 grid gap-5 sm:grid-cols-2">
        ...
        <label className="flex flex-col gap-1.5 text-sm sm:col-span-2">
          ...
          <p className="text-xs text-slate-500">
            Optional. Max 3MB input. The image will be auto-compressed before upload.
          </p>
          {form.imageUrl ? (
            <a
              href={form.imageUrl}
